...
def construct_model(args, dataset_info, dataloader_train):
    ...
    model = EGNN_dynamics_MP20_another2(
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.n_epochs):
        ...
        lattice_train_epoch(args=args, dataloader=dataloaders['train'], epoch=epoch, model=model, model_dp=model_dp,
        ...
        # 7 Testing
        if epoch % args.test_epochs == 0 and epoch != 0 and epoch >= args.visulaize_epoch:
            start_epoch = time.time()
