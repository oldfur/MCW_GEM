...
def setup_shared_args(parser):
    ...
    # parser.add_argument('--datadir', type=str, default='mp20/temp',
    #                     help='Directory to look up data from. (default: data/)')

    # Dataset options
    parser.add_argument('--num_train', type=int, default=27138, metavar='N',
                        help='Number of samples to train on')
    parser.add_argument('--num_val', type=int, default=9046, metavar='N',
    ...
    parser.add_argument("--dtype", type=str, default="float32", help="dtype for the model")
