...
def _run_config_payload(args, epoch):
    ...
    return {
        ...
        "zbl_correction_inner_steps": int(getattr(args, "zbl_correction_inner_steps", 20)),
        "zbl_correction_step_size": float(getattr(args, "zbl_correction_step_size", 1e-3)),
        "zbl_correction_r_cut": float(getattr(args, "zbl_correction_r_cut", 0.8)),
        "zbl_correction_force_clip": float(getattr(args, "zbl_correction_force_clip", 100.0)),
        "zbl_correction_max_step": float(getattr(args, "zbl_correction_max_step", 0.02)),
        "interleaved_zbl_steps": int(getattr(args, "interleaved_zbl_steps", 10)),
        "interleaved_zbl_step_size": float(getattr(args, "interleaved_zbl_step_size", 1e-3)),
        "interleaved_zbl_r_cut": float(getattr(args, "interleaved_zbl_r_cut", 0.8)),
        "interleaved_zbl_force_clip": float(getattr(args, "interleaved_zbl_force_clip", 100.0)),
        "interleaved_zbl_max_step": float(getattr(args, "interleaved_zbl_max_step", 0.02)),
