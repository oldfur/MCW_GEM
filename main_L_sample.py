...
from mp20.sample_epoch import sample_L
from mp20.crystal import lattice_matrix
...
def main(args):
    ...
    length, angle = sample_L(args, device, model, dataset_info, nodesxsample=nodesxsample)
